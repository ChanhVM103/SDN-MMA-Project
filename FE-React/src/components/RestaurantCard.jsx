...
function RestaurantCard({ restaurant, navigate }) {
  ...
  const image = restaurant.image || "https://cf.shopee.vn/file/vn-11134201-7qukw-lkbscl2h9e3rc4";
  ...
  return (
    <div
      ...
      style={{ cursor: "pointer", textDecoration: "none", color: "inherit", display: "flex", flexDirection: "column", height: "100%" }}
    >
