...
import { updateAvatarApi, updateProfileApi } from "../services/auth-api";
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      if (file.size > 2.5 * 1024 * 1024) {
        alert("Dung lượng file tối đa là 2.5MB");
        return;
      }
      setAvatarFile(file);
        ...
        <div style={{ padding: "0 30px" }}>
          ...
          <div style={{ display: "flex", padding: "30px 0" }}>
            ...
            <div style={{ width: "280px", display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "20px" }}>
              ...
              <div style={{ color: "#999", fontSize: "14px", textAlign: "center", lineHeight: "1.5" }}>Dụng lượng file tối đa 2.5 MB<br />Định dạng: .JPEG, .PNG</div>
