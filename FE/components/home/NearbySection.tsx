...
const NEARBY = [
    ...
    { id: '3', name: 'Trà Sữa Gong Cha', distance: '500m', time: '12 phút', rating: 4.6, emoji: '🧋', promo: '', isFlashSale: false, discountPercent: 0, deliveryTime: 12, deliveryFee: 15000, isOpen: true, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80', tags: ['Trà sữa', 'Đài Loan'], menu: [{ id: 'm1', name: 'Trà Sữa Trân Châu', price: 45000, emoji: '🧋', category: 'Trà Sữa', isBestSeller: true, description: 'Trân châu đen, trà sữa' }, { id: 'm2', name: 'Matcha Latte', price: 55000, emoji: '🍵', category: 'Trà Sữa', isNew: true, description: 'Matcha Nhật nguyên chất' }] },
